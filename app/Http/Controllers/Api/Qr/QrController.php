...
use App\Http\Requests\Qr\CreateUserQrRequest;
...
class QrController extends Controller
{
    ...
    public function createUserQr(CreateUserQrRequest $request, Booking $booking, CreateUserQrHandler $handler): JsonResponse
    {
        $create_user_qr = $handler->handle($booking, $request->user(), $request->toDTO());
